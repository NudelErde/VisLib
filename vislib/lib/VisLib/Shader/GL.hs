...
class (ShaderTypeable a) => UniformValue a where
  bindUniform :: GL.UniformLocation -> a -> IO ()
...
instance UniformValue (M22 Float) where
  bindUniform (GL.UniformLocation loc) (V2 (V2 a b) (V2 c d)) = withArray [a, b, c, d] $ GLF.glUniformMatrix2fv loc 1 1

instance UniformValue (M23 Float) where
  bindUniform (GL.UniformLocation loc) (V2 (V3 a b c) (V3 d e f)) = withArray [a, b, c, d, e, f] $ GLF.glUniformMatrix2x3fv loc 1 1

instance UniformValue (M24 Float) where
  bindUniform (GL.UniformLocation loc) (V2 (V4 a b c d) (V4 e f g h)) = withArray [a, b, c, d, e, f, g, h] $ GLF.glUniformMatrix2x4fv loc 1 1

instance UniformValue (M32 Float) where
  bindUniform (GL.UniformLocation loc) (V3 (V2 a b) (V2 c d) (V2 e f)) = withArray [a, b, c, d, e, f] $ GLF.glUniformMatrix3x2fv loc 1 1

instance UniformValue (M33 Float) where
  bindUniform (GL.UniformLocation loc) (V3 (V3 a b c) (V3 d e f) (V3 g h i)) = withArray [a, b, c, d, e, f, g, h, i] $ GLF.glUniformMatrix3fv loc 1 1

instance UniformValue (M34 Float) where
  bindUniform (GL.UniformLocation loc) (V3 (V4 a b c d) (V4 e f g h) (V4 i j k l)) = withArray [a, b, c, d, e, f, g, h, i, j, k, l] $ GLF.glUniformMatrix3x4fv loc 1 1

instance UniformValue (M42 Float) where
  bindUniform (GL.UniformLocation loc) (V4 (V2 a b) (V2 c d) (V2 e f) (V2 g h)) = withArray [a, b, c, d, e, f, g, h] $ GLF.glUniformMatrix4x2fv loc 1 1

instance UniformValue (M43 Float) where
  bindUniform (GL.UniformLocation loc) (V4 (V3 a b c) (V3 d e f) (V3 g h i) (V3 j k l)) = withArray [a, b, c, d, e, f, g, h, i, j, k, l] $ GLF.glUniformMatrix4x3fv loc 1 1

instance UniformValue (M44 Float) where
  bindUniform (GL.UniformLocation loc) (V4 (V4 a b c d) (V4 e f g h) (V4 i j k l) (V4 m n o p)) = withArray [a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p] $ GLF.glUniformMatrix4fv loc 1 1

instance UniformValue (M22 Double) where
  bindUniform (GL.UniformLocation loc) (V2 (V2 a b) (V2 c d)) = withArray [a, b, c, d] $ GLF.glUniformMatrix2dv loc 1 1

instance UniformValue (M23 Double) where
  bindUniform (GL.UniformLocation loc) (V2 (V3 a b c) (V3 d e f)) = withArray [a, b, c, d, e, f] $ GLF.glUniformMatrix2x3dv loc 1 1

instance UniformValue (M24 Double) where
  bindUniform (GL.UniformLocation loc) (V2 (V4 a b c d) (V4 e f g h)) = withArray [a, b, c, d, e, f, g, h] $ GLF.glUniformMatrix2x4dv loc 1 1

instance UniformValue (M32 Double) where
  bindUniform (GL.UniformLocation loc) (V3 (V2 a b) (V2 c d) (V2 e f)) = withArray [a, b, c, d, e, f] $ GLF.glUniformMatrix3x2dv loc 1 1

instance UniformValue (M33 Double) where
  bindUniform (GL.UniformLocation loc) (V3 (V3 a b c) (V3 d e f) (V3 g h i)) = withArray [a, b, c, d, e, f, g, h, i] $ GLF.glUniformMatrix3dv loc 1 1

instance UniformValue (M34 Double) where
  bindUniform (GL.UniformLocation loc) (V3 (V4 a b c d) (V4 e f g h) (V4 i j k l)) = withArray [a, b, c, d, e, f, g, h, i, j, k, l] $ GLF.glUniformMatrix3x4dv loc 1 1

instance UniformValue (M42 Double) where
  bindUniform (GL.UniformLocation loc) (V4 (V2 a b) (V2 c d) (V2 e f) (V2 g h)) = withArray [a, b, c, d, e, f, g, h] $ GLF.glUniformMatrix4x2dv loc 1 1

instance UniformValue (M43 Double) where
  bindUniform (GL.UniformLocation loc) (V4 (V3 a b c) (V3 d e f) (V3 g h i) (V3 j k l)) = withArray [a, b, c, d, e, f, g, h, i, j, k, l] $ GLF.glUniformMatrix4x3dv loc 1 1

instance UniformValue (M44 Double) where
  bindUniform (GL.UniformLocation loc) (V4 (V4 a b c d) (V4 e f g h) (V4 i j k l) (V4 m n o p)) = withArray [a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p] $ GLF.glUniformMatrix4dv loc 1 1